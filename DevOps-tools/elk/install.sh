...
curl -s "https://gitlab.com/thecloudcareers/opensource/-/raw/master/common-functions.sh" >/tmp/common-functions.sh
...
curl -s https://gitlab.com/thecloudcareers/opensource/-/raw/master/lab-tools/elk/http-proxy.conf >/etc/nginx/nginx.conf
